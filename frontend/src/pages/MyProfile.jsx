...
const MyProfile = () => {
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm ml-10'>
      ...
      <div>
        {
          isEdit ? <button onClick={() => setIsEdit(false)} className='border border-primary text-gray-900 px-4 py-2 rounded-md hover:bg-primary hover:text-black transition-all duration-300'>Save</button>
            : <button onClick={() => setIsEdit(true)} className='border border-primary text-gray-900 px-4 py-2 rounded-md hover:bg-primary hover:text-black transition-all duration-300'>Edit Profile</button>
        }
      </div>
    </div>
  )
