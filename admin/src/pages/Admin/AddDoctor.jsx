...
const AddDoctor = () => {
    ...
    return (
        <form className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border border-gray-400 rouded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Fees</p>
                            <input className='border rounded px-3 py-2' type="number" placeholder='Fees' />
                        </div>
                    </div>
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        <div className='flex-1 flex flex-col gap-1'>
                ...
                <button className='bg-primary px-10 py-3 mt-4 text-black rounded-full'>Add Doctor</button>
            </div>
        </form>
    )
}
